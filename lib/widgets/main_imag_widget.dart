  ...
  Widget build(BuildContext context){
    ...
    return Stack(
                      children: [
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image:
                                  AssetImage(widget.items[selectedButtonButtom]["image"]!),
                              fit: BoxFit.cover,
                       ...
                       if(widget.withlowerbuttons)...[Align(
                        ...
                        if(widget.withupperbuttons)...[
                          ScrolledButtonList(withlogo: true,selectedButtonButtom: selectedButtonTop,
                          BPress: [(){setState(() {selectedButtonTop =0;}); }
                          ,(){setState(() {selectedButtonTop =1;});},
                          (){setState(() {selectedButtonTop =2;});},
                          (){setState(() {selectedButtonTop =3;});}],
                          )
                        ],
                      ],
                    );
