...
import 'package:syncfusion_flutter_sliders/sliders.dart';
      ...
      {"image": "assets/image/movie_logo.png", "title": "Alp Arslan","day":"thursday","season":"5","star":"4.7/5","desc":"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged."},
...
int isSelected = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
              ...
              children: [
                Container(
                  ...
                  Positioned(
                    ...
                    child:IconButton(onPressed: (){},
                     icon: Icon(Icons.play_arrow_rounded , size: 200,color: Colors.red,))
                ...
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                    Text(items[0]["title"]!,style: TextStyle(fontSize: 27),),
                ...
                Row(
                    ...
                    child: Stack(
                      ...
                      children: [
                       Positioned(
                          bottom: 12,
                        child: 
                        IconButton(onPressed: (){}, icon: Icon(Icons.add_circle_outline,size: 30,color: Color(0XFFB3B3B3),))),
                        Positioned(
                          top: 40,
                          child:Text("My List",style: TextStyle(fontSize: 10),))
                      ],
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: [
                    Icon(Icons.star_border_outlined,size: 35,color: Color(0XFFB3B3B3),),
                    Text(items[0]["star"]!,style: TextStyle(fontSize: 10),)
                  ],),

                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                    Icon(Icons.calendar_today_outlined,size: 35,color: Color(0XFFB3B3B3),),
                    Text(items[0]["day"]!,style: TextStyle(fontSize: 10),)
                  ],)
      ...
      activeColor: const Color.fromARGB(255, 255, 0, 0), // لون الجزء النشط
      inactiveColor: const Color.fromARGB(255, 255, 0, 0), // لون الجزء غير النشط
  ...
  return Column(
    children: List.generate(4, (i) {
      return Column(
        children: [
          EpisodeTile(
            image: items[0]["image"]!,  // استخدم مسار الصورة وفقًا للبيانات المتوفرة لديك
            title: "Epsoid ${i + 1}",
            DownloadButton: () {
